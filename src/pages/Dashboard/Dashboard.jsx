      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-7 sm:px-6 lg:px-8 lg:py-10">
        ...
        <section className="mt-7" aria-labelledby="workspace-overview">
          <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link to="/account#plans" className="inline-flex items-center justify-center rounded-xl border border-blue-500/40 bg-blue-950/60 px-4 py-2.5 text-sm font-black text-blue-200 transition hover:border-blue-400 hover:bg-blue-900/60">Manage Plan →</Link>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
            <Link to="/builder" className="group rounded-2xl border border-gray-800 bg-gray-900 p-5 transition hover:-translate-y-0.5 hover:border-blue-600/60 hover:bg-gray-900/90">
            ...
            <Link to="/reference-coding" className="group rounded-2xl border border-teal-500/30 bg-gradient-to-br from-teal-950/50 via-gray-900 to-indigo-950/50 p-5 transition hover:-translate-y-0.5 hover:border-teal-400/60">
            ...
            <Link to="/history" className="group rounded-2xl border border-gray-800 bg-gray-900 p-5 transition hover:-translate-y-0.5 hover:border-indigo-600/60">
        ...
        <section className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-5">
          <div className="rounded-2xl border border-gray-800 bg-gray-900 p-6 lg:col-span-3">
          ...
          <div className="rounded-2xl border border-teal-500/25 bg-gradient-to-br from-gray-900 to-teal-950/40 p-6 lg:col-span-2">
